...
class Articulo(models.Model):
    ...
    Imagen = models.ImageField(
        null=True, blank=True, upload_to="imagenes_articulos/")
...
class Transaccion(models.Model):
    ...
    Articulo = models.ForeignKey(
        Articulo, null=False, blank=False, on_delete=models.CASCADE)
    TransaccionTipo = models.ForeignKey(
        TransaccionTipo, null=False, blank=False, on_delete=models.CASCADE)
